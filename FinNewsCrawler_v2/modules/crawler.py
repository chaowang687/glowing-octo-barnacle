...
finnews_path = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
sys.path.insert(0, finnews_path)

# 硬编码配置变量
BASE_DIR = finnews_path
...
from modules.parser import NewsParser, FundParser, SectorParser
